...
/*   	  	$('#').click(function(){
  	...
  	function recipeSubmit() {
  		...
  		//summernote적용과 이미지 업로드를 위한 function
...
<body style="background-color: #F6F6F6">
				...
				<li>
					<div style="padding-top: 9px; padding-left: 5px;">
						<button type="button" class="btn form" data-toggle="modal"
							data-target="#fridge">
							<img src="./resources/ingredient_icon/fridge.png"
	...
	<div id="columns" style="margin: 50px;">
		...
		%>
		<figure> <a href="#" class="imageHover"> <img
			class="imgsrc" id="enters" src="<%=recipe.getImg_url()%>"
			onclick="post(<%=recipe.getRecipe_id()%>)">
		</a> </figure>
		<%
			}
		%>
	...
	<!-- 게시물 post 버튼 -->
	<div id="postQuick">
		<button type="button" data-target="#postModal" id="postBtn"
			class="btn btn-danger" data-spy="affixBtn" style="margin-left: 97%">+</button>
	...
	<!-- Modal -->
		...
		<div class="modal fade" id="postModal" role="dialog"
			style="margin-top: 130px;" data-backdrop="static">
			<div class="modal-dialog">

				<!-- Modal content-->
				<form id="recipeInsert" action="">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">x</button>
						<recipe style="font-size:20px;font-weight:bold">
						<span class="glyphicon glyphicon-cutlery"></span> 레시피 등록</recipe>
					</div>
					<div>
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="usrname"> <span
									class="glyphicon glyphicon-cutlery"></span> 요리명
								</label>

								<div>
									<!-- 사진: board_img -->
									<div class="file-upload" id="upload_recipe_pic">
										<label for="upload" class="file-upload__label"> <span
											class="glyphicon glyphicon-camera"></span>사진등록
										</label> <input id="recipeInsert" class="file-upload__input"
											type="file" name="recipeInsert">
									</div>
									...
									<input type="text" class="form-control" name="recipe_title"
										id="recipe_title" placeholder="요리명 입력"
										style="margin-bottom: 5px"> <input type="text"
										class="form-control" name="recipe_desc" id="recipe_desc"
										placeholder="한줄 설명">
								</div>
							...
							<div class="form-group">
								<div>
									<label> <span class="glyphicon glyphicon-map-marker"></span>
										국가
									</label> <select name="nation_code" id="nation_code"
										class="form-control">
									...
									</select> <br> <label> <span
										class="glyphicon glyphicon-tags"></span> 종류
									</label> <select name="ty_code" id="ty_code" class="form-control">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="psw"> <span
									class="glyphicon glyphicon-shopping-cart"></span> 재료 입력
								</label>

								<!-- + -->
								<button type="button" id="irdntAddBtn"
									class="btn btn-primary btn-xs">+</button>
								<div id="irdntAdd">
									<input type="text" class="form-control" name="irdnt_name"
										id="irdnt_name" placeholder="재료 입력"
										style="margin-bottom: 5px;"> <input type="text"
										class="form-control" name="irdnt_cpcty" id="irdnt_cpcty"
										placeholder="분량 입력" style="margin-bottom: 5px;">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="psw"> <span
									class="glyphicon glyphicon-sort-by-order"></span> 레시피 입력
								</label>
								<!-- + -->
								<input type="text" class="form-control" name="cooking_time"
									placeholder="예상시간(분)"
									style="width: 105px; margin-left: 80%; margin-bottom: 12px;">
								<button type="button" id="recipeProcessAddBtn"
									class="btn btn-primary btn-xs">+</button>
								<div id="reciptInput">
									<!-- 사진이미지: step_img_url -->
									<!-- 순서 -->
									1 <input type="hidden" name="cooking_no" id="cooking_no"
										value="1">
									<div class="file-upload">
										<label for="upload" class="file-upload__label"><span
											class="glyphicon glyphicon-camera"></span>사진등록</label>
										<!-- <input id="upload_recipe" class="file-upload__input" type="file" name="file-upload_recipe"> -->
									</div>
									<textarea name="cooking_desc" id="cooking_desc"
										class="form-control" style="margin-bottom: 5px;"
										placeholder="입력"></textarea>
									<input type="text" name="step_tip" id="step_tip"
										class="form-control" style="margin-bottom: 5px;"
										placeholder="TIP★ 입력">
								</div>
							</div>

							<button class="btn btn-block" onclick="javascript:recipeSubmit()">
