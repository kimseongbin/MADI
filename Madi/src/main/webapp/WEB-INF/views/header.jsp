...
<script>
	...
	$("#IrdntList").find("li").click(function() {
		...
		var li = "<li class='li hori'>"
				 ...
				 + "</a>"
				 + "</li>";
		if(findIrdntInFridge(my_irdnt)) {
			alert("내 냉장고에 추가되어 있는 재료입니다.");
		} else {
			if(findIrdntInList(my_irdnt)) {
				alert("추가 목록에 추가되어 있는 재료입니다.");	
			} else {
				$("#myIrdntList").append(li);
			}	
		}
	...
	function addIrdnt() {
		...
		$.ajax({
			...
			success: function(status) {
				...
				$("#myIrdntListForm").empty();
			}

		});
	}
	$("#myFridge").find("li").click(function() {
		var irdnt = $(this).find("input").val();
		var li = $(this);
		$.ajax({
